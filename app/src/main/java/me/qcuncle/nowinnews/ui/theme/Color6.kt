...
object Color6 {
    ...
    val md_theme_light_tertiaryContainer = Color(0xFFE7E6AD)
    ...
    val md_theme_light_inversePrimary = Color(0xFFFFB689)
    ...
    val md_theme_dark_onTertiaryContainer = Color(0xFFE7E6AD)
